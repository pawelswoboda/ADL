...
\begin{frame}{State of RL for Reasoning LLMs: Summary}
  ...
  \begin{description}
    ...
    \item[Loss Aggregation Criticality:] Sequence-level rewards combined with sample averaging introduce subtle token-level biases that fundamentally affect per-token learning signals.
