...
\usepackage[backend=biber, style=authoryear, maxcitenames=2, url=false, doi=false, isbn=false]{biblatex}
\addbibresource{references.bib}

% Custom inline citation format: Author, Title, Year
...
\begin{document}
  Each token (character) is mapped to a learnable feature vector --- its \textbf{token embedding}.
