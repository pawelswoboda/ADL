  ...
  \begin{columns}
    \begin{column}{0.48\textwidth}
      ...
      \begin{itemize}
        ...
        \item GPT2 small (124M) can be trained from scratch on a single GPU, ideal for studying training techniques
      \end{itemize}
  ...
  \begin{columns}
    \begin{column}{0.50\textwidth}
      ...
      \begin{itemize}
        ...
        \item \textbf{Residual projections} scaled by $\frac{0.02}{\sqrt{2L}}$: prevents residual stream variance from growing with depth
      \end{itemize}
    \end{column}
...
\begin{frame}{Mixed Precision Training}
  ...
  \begin{tikzpicture}[font=\small, scale=0.88, every node/.style={transform shape},
    ...
    % === Left: Storage ===
    \node[fp32] (mw) at (0, 7.0) {Master weights $\theta$};
    \node[lbl, above=0pt of mw] {float32};

    % Cast down
    \node[cast] (castdown) at (0, 5.9) {cast to bf16};
